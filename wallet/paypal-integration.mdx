---
title: "PayPal Orders API v2 Integration for Arena Deposits"
...
Arena integrates with PayPal Orders API v2 for all real-money deposits. This page explains how the integration works from order creation through wallet credit, how to test safely in the sandbox environment, and how to handle the edge cases you are most likely to encounter in production.
